Contributing to NodePay Core
============================

The NodePay Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nodepay-project/nodepay/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NodePay Core project, and is not to be
confused with overall NodePay Network Protocol consensus changes.

Whether a pull request is merged into NodePay Core rests with the project merge
...
Patches that change NodePay consensus rules are considerably more involved than
...
Where a patchset proposes to change the NodePay consensus, it must have been
...
The project leader is the release manager for each NodePay Core release.
