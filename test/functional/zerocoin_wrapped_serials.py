...
from fake_stake.base_test import NodePay_FakeStakeTest

class zAFMCwrappedSerialsTest(NodePay_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAFMCs..." % DENOM_TO_USE)
