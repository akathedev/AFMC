...
RESOURCES += src/qt/nodepay.qrc src/qt/nodepay_locale.qrc

TRANSLATIONS += src/qt/locale/nodepay_bg.ts \
                src/qt/locale/nodepay_de.ts \
                src/qt/locale/nodepay_en.ts \
                src/qt/locale/nodepay_es.ts \
                src/qt/locale/nodepay_fi.ts \
                src/qt/locale/nodepay_fr.ts \
                src/qt/locale/nodepay_it.ts \
                src/qt/locale/nodepay_ja.ts \
                src/qt/locale/nodepay_pl.ts \
                src/qt/locale/nodepay_pt.ts \
                src/qt/locale/nodepay_ru.ts \
                src/qt/locale/nodepay_sk.ts \
                src/qt/locale/nodepay_sv.ts \
                src/qt/locale/nodepay_vi.ts \
                src/qt/locale/nodepay_zh_CN.ts \
                src/qt/locale/nodepay_zh_TW.ts
