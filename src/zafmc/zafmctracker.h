...
#ifndef NodePay_ZAFMCTRACKER_H
#define NodePay_ZAFMCTRACKER_H
...
public:
    CzAFMCTracker(std::string strWalletFile);
    ~CzAFMCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAFMCWallet* zAFMCWallet = NULL);
