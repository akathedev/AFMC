...
#ifndef NodePay_ZAFMCWALLET_H
#define NodePay_ZAFMCWALLET_H
...
public:
    CzAFMCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAFMC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAFMC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
