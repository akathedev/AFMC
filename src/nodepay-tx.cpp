...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NodePay Core nodepay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodepay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodepay transaction") + "\n" +
                               "  nodepay-tx [options] -create [commands]   " + _("Create hex-encoded nodepay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodepay transaction
