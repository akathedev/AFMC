/* src/config/nodepay-config.h.  Generated from nodepay-config.h.in by configure.  */
/* src/config/nodepay-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AFMC_CONFIG_H

#define AFMC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.nodepay.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NodePay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NodePay Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nodepay"
