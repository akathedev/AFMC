...
/** Utility functions used by the NodePay Qt UI.
 */
namespace GUIUtil
{
...
// Render NodePay addresses in monospace font
...
// Parse "nodepay:" URI into recipient object, return true on successful parsing
