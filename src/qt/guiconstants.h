...
/* NodePay GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NodePay"
#define QAPP_ORG_DOMAIN "nodepay.org"
#define QAPP_APP_NAME_DEFAULT "NodePay-Qt"
#define QAPP_APP_NAME_TESTNET "NodePay-Qt-testnet"
