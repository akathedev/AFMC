...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::AFMC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNodePayAmount"))
        SoftSetArg("-anonymizenodepayamount", settings.value("nAnonymizeNodePayAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nodepay.cpp during shotdown to also remove the window positions
