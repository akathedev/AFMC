...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "NodePay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NodePay features */
        {"nodepay", "listmasternodes", &listmasternodes, true, true, false},
        {"nodepay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodepay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodepay", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nodepay", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nodepay", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nodepay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodepay", "masternodedebug", &masternodedebug, true, true, false},
        {"nodepay", "startmasternode", &startmasternode, true, true, false},
        {"nodepay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodepay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodepay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodepay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodepay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodepay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodepay", "preparebudget", &preparebudget, true, true, false},
        {"nodepay", "submitbudget", &submitbudget, true, true, false},
        {"nodepay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodepay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodepay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodepay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodepay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodepay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodepay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodepay", "checkbudgets", &checkbudgets, true, true, false},
        {"nodepay", "mnsync", &mnsync, true, true, false},
        {"nodepay", "spork", &spork, true, true, false},
        {"nodepay", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzafmcseed", &getzafmcseed, false, false, true},
        {"zerocoin", "setzafmcseed", &setzafmcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzafmc", &searchdzafmc, false, false, true},
        {"zerocoin", "dzafmcstate", &dzafmcstate, false, false, true},
...
{
    return "> nodepay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13785/\n";
}
