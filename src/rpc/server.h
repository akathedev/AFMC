...
/**
 * NodePay RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZafmcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzafmcseed(const UniValue& params, bool fHelp);
extern UniValue getzafmcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzafmc(const UniValue& params, bool fHelp);
extern UniValue dzafmcstate(const UniValue& params, bool fHelp);
