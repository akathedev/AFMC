...
extern UniValue DoZnpccSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setznpccseed(const UniValue& params, bool fHelp);
extern UniValue getznpccseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznpcc(const UniValue& params, bool fHelp);
extern UniValue dznpccstate(const UniValue& params, bool fHelp);
